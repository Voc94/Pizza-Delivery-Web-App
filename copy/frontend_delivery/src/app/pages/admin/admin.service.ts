...
export class AdminService {
  ...
  createUser(userDTO: UserDTO): Observable<UserDTO> {
    console.log('Creating user with:', userDTO);  // Debugging line to check what is being sent
...
updateUser(userId: number, userDTO: UserDTO): Observable<UserDTO> {
    console.log('Updating user with:', userDTO);  // Debugging line to check what is being sent
